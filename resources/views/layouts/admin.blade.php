    ...
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav ml-auto">
                <li class="nav-item">
                    <div class="alert alert-warning m-0" style="
    padding-top: 0.3rem;
    padding-bottom: 0.3rem;
" role="alert">
                        Seu pagamento ainda não foi identificado. Seu acesso será suspenso em
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            <a href="#" class="brand-link">
                <img src="{{ asset('images/logo-transparente.png') }}" alt="UTrack Logo" class="brand-image elevation-3"
                    style="opacity: .8">
